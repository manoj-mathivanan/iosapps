...
@property (nonatomic, retain) NSString* complexTypeName; //only available if the type is EDM_TYPE_COMPLEX and not a root property and contains the complex property type name
