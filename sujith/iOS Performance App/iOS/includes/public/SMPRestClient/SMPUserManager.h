...
/**
 @class SMPUserManager
 This class consists of methods to register or de-register a user. All the function calls in this class have various ways of provisioning settings on to the client and register the user with the help of these settings. You can check if a user is registered and delete the user as required.
