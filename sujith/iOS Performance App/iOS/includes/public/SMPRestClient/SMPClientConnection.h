...
/**
 ...
 This class consists of methods used to interact with the underlying client to register connection settings. The application can initialize/set connection by providing hostname, port, applicationID, domain and security configuration.
 */
 ...
 * <pre>
 *  SMPClientConnection* clientConn = [SMPClientConnection initializeWithAppID:@"application ID" domain:@"domain" secConfiguration:@"secconfig"];
 * [clientConneciton setConnectionProfileWithHost:@"10.66.177.94" port:@"8000" farm:nil relayServerUrlTemplate:nil enableHTTP:YES];
 * </pre>
 * @examples
 ...
 * <pre>
 *  SMPClientConnection* clientConn = [SMPClientConnection initializeWithAppID:@"application ID" domain:@"domain" secConfiguration:@"secconfig"];
 *  [clientConn setConnectionProfileWithUrl:@"http://10.66.177.94:8000"];
 * </pre>
 * @examples
 * In case of relay server
 * <pre>
 *  [clientConn setConnectionProfileWithUrl:@"http://relayserver.sybase.com:80/ias_relay_server/client/rs_client.dll/relay.farm"];
 * </pre>
 */
...
/**
 * Retreives the application Connection ID.
 */
