...
/*!
 @protocol ODPHTTPSClientCertificateChallengeListenerDelegate
 @abstract
 @discussion
 */
@protocol ODPHTTPSClientCertificateChallengeListenerDelegate <NSObject>
...
/*!
 @method
 @abstract Called from the application to invoke the challenge handler delegates.
 @discussion This function is used to tell the communication library to invoke the challenge handler delegates.
 @param challengeResult identity indicating the client identity.
 * <pre>
 *  Usage
 * <code>
 * [ODPClientListeners httpsClientCertificateChallengeResult:<value>];
 * </code>
 * </pre>
 */
+(void)httpsClientCertificateChallengeResult:(SecIdentityRef) identity;
...
/*!
 @method
 @abstract Setter for the HTTPS Client Certificate Challenge Listener.
 @discussion This is a class method to register the HTTPS Client Certificate Challenge Listener with the ODP Client framework
 @param listener A listener object whose definition adheres to the appropriate protocol.
 *  <pre>
 *  Usage
 *  <code>
 *  [ODPClientListeners setHTTPSClientCertificateChallengeListenerDelegate:self];
 *  </code>
 *  </pre>
 */

+(void)setHTTPSClientCertificateChallengeListenerDelegate:(id<ODPHTTPSClientCertificateChallengeListenerDelegate>)listener;

/*!
 @method
 @abstract Getter for the HTTPS Client Certificate Challenge Listener.
 @discussion This is a class method to fetch the HTTPS Client Certificate Challenge Listener object
 @result Instance of the listener object.
 */
+(id<ODPHTTPSClientCertificateChallengeListenerDelegate>)getHTTPSClientCertificateChallengeListenerDelegate;
