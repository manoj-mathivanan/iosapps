...
/*!
 ...
 <br/>
 70005   -  SAP Mobile Platform internal parsing error. 
 <br/>
...
/**
 Relay server farm to which SAP Mobile Server belongs. It is important only when connecting via relay server. 
 */
 ...
 * @param hostName Host name or IP Address of the SAP Mobile Server.
 * @param portNumber Port number of the SAP Mobile Server with which the client communicates.
 * @param farmId Relay server farm ID to which the SAP Mobile Server belongs. Relevant only during registration through relay server.
