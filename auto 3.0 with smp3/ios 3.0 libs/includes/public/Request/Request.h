 ...
 */
typedef enum {
	_NoAuthenticationNeededYet = 0,  ///< no authentication needed
	_HTTPAuthenticationNeeded = 1,   ///< server with basic authentication requests credentials
	_ProxyAuthenticationNeeded = 2   ///< proxy authentication required
 ...
 */
typedef enum {
    _ConnectionFailureErrorType = 1,		///< Connection Failure
    _RequestTimedOutErrorType = 2,		///< Timeout
    _AuthenticationErrorType = 3,		///< Authentication problem
    _RequestCancelledErrorType = 4,		///< HTTP request cancelled
    _UnableToCreateRequestErrorType = 5, ///< Request creation error
    _InternalErrorWhileBuildingRequestType  = 6, ///< Denotes an internal library error
    _InternalErrorWhileApplyingCredentialsType  = 7, ///< Denotes an internal library error
	_FileManagementError = 8,            ///< Issues while storing / loading files
	_TooMuchRedirectionErrorType = 9,    ///< Redirection limit exceeded
	_UnhandledExceptionError = 10,       ///< This one caught us unprepared
	_InternalServerError = 11            ///< response status code 500 received from the server
} ENetworkErrorType;
...
/**
 * Convenience constructor that creates a Request object with the given HTTP or HTTPS url.
 * The url may incude username and passowrd for basic authentication.
 * @param newURL Object of NSURL class.
 * @return Returns an instance of the Request class.
 * @examples
...
/**
 * Convenience constructor that creates a Request object with the given HTTP or HTTPS url and cache.
 * The url may incude username and passowrd for basic authentication.
 * @param newURL Object of NSURL class.
...
/**
 * Convenience constructor that creates a Request object with the given HTTP or HTTPS url and cache with predefined cache policy.
 * The url may incude username and passowrd for basic authentication.
 * @param newURL Object of NSURL class.
 * @param cache Object implementing CacheDelegate protocol.
 ...
 * @examples
 * <pre>
 *  Request *request = [Request requestWithURL:[[NSURL alloc] initWithString:applicationEndpoint] usingCache:self andCachePolicy:_DefaultCachePolicy];
 * </pre>
 */
 ...
 * @param file NSString object indicating the complete path to the file.
 * @examples
 * <pre>
 *  [req appendPostDataFromFile:filePath];
 * </pre>
 */
 ...
 * @param matchType EetagMatchType enum value.
 * @examples
 * <pre>
 *  [req setEtag:etag withMatchType:_EtagIfMatch];
 * </pre>
 */
- (void)setEtag:(NSString *)etag withMatchType:(EetagMatchType) matchType;

/**
 * Enable XSRF support. It is disabled by default.
 * @examples
 * <pre>
