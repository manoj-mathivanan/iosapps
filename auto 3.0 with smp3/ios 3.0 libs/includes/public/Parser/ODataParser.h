 ...
 */
NSMutableArray* parseODataEntriesXML(NSData* const content_in, const ODataEntitySchema* const entitySchema, const ODataServiceDocument* const serviceDocument);
/**
